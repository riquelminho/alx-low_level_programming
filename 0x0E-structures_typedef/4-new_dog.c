...
*
* Return: pointer to a new struct dog, or NULL if malloc fails.
*
* Description: creates a new struct dog with the provided name, age, and owner,
* storing copies of the name and owner strings in the new struct.
*/
